    ...
    <Container maxWidth="120vw" disableGutters sx={{position: 'relative'}}>
      ...
      <Grid container spacing={4} color="#232946">  
        ...
        <div style={{
          ...
          <iframe width="85%" height="100%" frameborder="0" src="https://www.youtube.com/embed/WTVcHCGQDik?version=3&autoplay=1&loop=1&mute=1&playlist=WTVcHCGQDik" allow='autoplay'/>
        </div>
      </Container>
